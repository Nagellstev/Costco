...
As a customer I want to browse a product page so I can make a buying decision
...
Scenario: [Order more limited items than allowed]
	...
	And I enter to the product amount field maximum number of limited items plus one
	And I press add to cart button
